...
INSERT INTO jc_university (university_code, university_name) VALUES
...
(6, 'Московский государственный технический университет имени Н.Э. Баумана'),
(7, 'Томский государственный университет'),
(8, 'Казанский (Приволжский) федеральный университет'),
(9, 'Уральский федеральный университет имени Б.Н. Ельцина'),
